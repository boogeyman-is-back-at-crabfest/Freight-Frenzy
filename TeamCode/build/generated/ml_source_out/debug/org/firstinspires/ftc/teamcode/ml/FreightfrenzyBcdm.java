...
public final class FreightfrenzyBcdm {
  @NonNull
  ...
  private FreightfrenzyBcdm(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    model = Model.createModel(context, "FreightFrenzy_BCDM.tflite", options);
    ...
    labelMap = FileUtil.loadLabels(extractor.getAssociatedFile("label_map.txt"));
  ...
  @NonNull
  public static FreightfrenzyBcdm newInstance(@NonNull Context context) throws IOException {
    return new FreightfrenzyBcdm(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FreightfrenzyBcdm newInstance(@NonNull Context context,
      @NonNull Model.Options options) throws IOException {
    return new FreightfrenzyBcdm(context, options);
  }
  ...
  public class Outputs {
    ...
    private List<RectF> getLocationAsRectFList() {
      List<RectF> originalBoxes = BoundingBoxUtil.convert(location, new int[] {1,0,3,2}, 2, BoundingBoxUtil.Type.BOUNDARIES, BoundingBoxUtil.CoordinateType.RATIO, 300, 300);
